...
import { authRecoverySchema, authSchema } from "../models/user.model.js";

export const authRoutes = Router();

authRoutes.post("/auth/login", celebrate({ [Segments.BODY]: authSchema }), asyncHandler(AuthController.login));
